		...
		public static function return_output() {
			...
			if( 'default' != $logo_layouts ) {
				...
				if( 'right' == $header_logo_alignment ) {
					$bstone_logo_layout_outer_css['.st-site-identity']['justify-content'] = 'flex-start';
				}
			...
			/* RTL Footer */
			$bstone_rtl_footer = array(
				'.site-footer .st-row' => array(
					'-js-display' => 'flex',
					'display'     => '-webkit-box',
					'display'     =>  '-webkit-flex',
					'display' 	  =>  '-moz-box',
			...
			$parse_css .= bstone_parse_css( $bstone_rtl_footer, '769' );
